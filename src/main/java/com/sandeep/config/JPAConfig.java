...
public class JPAConfig {
    ...
    private @Value( "jdbc:mysql://localhost:3306/test" ) String dbURL;
    private @Value( "com.mysql.jdbc.Driver" ) String driverClass;
    private @Value( "root" ) String dbUser;
    private @Value( "root" ) String dbPassword;
    private @Value( "10" ) Integer maxPoolSize;
    private @Value( "org.hibernate.dialect.MySQL5Dialect" ) String hibernateDialect;
    private @Value( "true" ) String showSql;
    private @Value( "true" ) String hbm2ddlStrategy;
    private @Value( "10" ) int restTemplateMaxConnection;
    private @Value( "10" ) int restTemplateMaxConnectionPerRoute;
