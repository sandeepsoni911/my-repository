...
public class LoanDetailsController {
	...
	public @ResponseBody String saveLoan(@RequestBody LoanDetailsDto detailsDto){
		String response = null;
		if(detailsDto == null){
			return "Required details are null or empty";
		}
		response = loanBusiness.saveLoanDetails(detailsDto);
